                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6 mt-3">
                                <div class="form-floating mb-3">
                                    <input type="search" class="form-control fs" id="email" name="email" placeholder="email">
                                    <label for="email"><i class="fa-solid fa-magnifying-glass"></i>
                                        Digite seu E-mail
                                    </label>
                                </div>
                            </div>
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fa-solid fa-at"></i>E-mail</th>
